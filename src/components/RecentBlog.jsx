            ...
            <div className='max-w-7xl mx-auto flex gap-6'>
                ...
                <div className='bg-white hidden md:block dark:bg-gray-700 w-[350px] p-5 rounded-md mt-10'>
                    ...
                    <div className='my-5 flex flex-wrap gap-3'>
                        {
                            ["Blogging", "Web Development", "Digital Marketing", "Photography", "Cooking", "Others"].map((item, index) => {
                    ...
                    <div className='flex flex-col sm:flex-row gap-2 max-w-md mx-auto mt-5'>
                        <Input type="email" placeholder="Enter your email " className="flex h-10 rounded-md border bg-gray-200 dark:bg-gray-800 px-3 py-2 text-sm text-gray-300" />
