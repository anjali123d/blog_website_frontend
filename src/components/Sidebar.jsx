...
const Sidebar = () => {
  return (
    <div className="hidden mt-10 fixed md:block border r-2 dark:bg-gray-800 bg-white border-gray-300 dark:border-gray-300 w-[300px]  p-10 space-y-2 h-screen z-10">
